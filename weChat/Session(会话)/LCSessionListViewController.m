...
- (void)viewDidLoad {
    ...
    LCSessionList *list1 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_0" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.sessionList addObject:list1];
    LCSessionList *list2 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_1" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.sessionList addObject:list2];
    LCSessionList *list3 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_2" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:nil time:@"15:35"];
    [self.sessionList addObject:list3];
    LCSessionList *list4 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_3" name:@"Simon" detailSession:nil  unreadCount:@"99" time:@"15:35"];
    [self.sessionList addObject:list4];
    LCSessionList *list5 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_0" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.sessionList addObject:list5];
    LCSessionList *list6 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_1" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.sessionList addObject:list6];
    LCSessionList *list7 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_2" name:@"Simon" detailSession:@"源码于 https://github.com/icoderRo/LCWeChat" unreadCount:nil time:@"15:35"];
    [self.sessionList addObject:list7];
    LCSessionList *list8 = [LCSessionList internalSessionListWithHeadrImage:@"aio_voiceChange_effect_3" name:@"Simon" detailSession:nil  unreadCount:@"99" time:@"15:35"];
