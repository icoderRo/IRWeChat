...
- (void)viewDidLoad {
    ...
    LCGroupList *list2 = [LCGroupList internalGroupListWithHeadrImage:@"aio_voiceChange_effect_6" name:@"福利彩票" detailSession:@"源码请关注 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.groupList addObject:list2];
    LCGroupList *list3 = [LCGroupList internalGroupListWithHeadrImage:@"aio_voiceChange_effect_3" name:@"售后服务" detailSession:@"源码请关注 https://github.com/icoderRo/LCWeChat" unreadCount:nil time:@"15:35"];
    ...
    LCGroupList *list6 = [LCGroupList internalGroupListWithHeadrImage:@"aio_voiceChange_effect_6" name:@"福利彩票" detailSession:@"源码请关注 https://github.com/icoderRo/LCWeChat" unreadCount:@"99" time:@"15:35"];
    [self.groupList addObject:list6];
    LCGroupList *list7 = [LCGroupList internalGroupListWithHeadrImage:@"aio_voiceChange_effect_3" name:@"售后服务" detailSession:@"源码请关注 https://github.com/icoderRo/LCWeChat" unreadCount:nil time:@"15:35"];
